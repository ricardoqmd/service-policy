 ...
 *
 * <p>Uniqueness of {@code policyId} is enforced by a unique index (see {@link PolicyLifecycleIndexes}),
 * which gives the same "at most one head per policy" guarantee as a natural key without changing the
 * repository's {@link ObjectId} convention used across this codebase.
 */
